...
<body>
	<!-- <div class="bg-dark text-white header-position" id="header">Header</div> -->
	<div id="fullpage">
		<svg class="position-absolute" viewbox="0 0 600 225">
			<clippath id="textClip" class="filled-heading mt-5 ml-5">
					<text class="color display-1" y="70">ITMZ</text>
					<text class="color display-1" y="140">IT</text>
					<text class="color display-1" y="210">CONSULTING</text>
			</clippath>
		...
		<div class="position-absolute text-position text-white pt-5 ml-4 w-100">
			<div class="text-left d-flex ml-5 pl-5 justify-content-left position-relative">
			...
			<div class="mt-3 pl-5 ml-5 text-left hero-text">
				<h1>Specializing in IT Solutions</h1>
				<p>Catering small to medium size businesses
				...
				<p>Onsite, remote and one-on-one consulting.<br>
					Let us help you figure out you'r best IT options!</p>
			</div>
		</div>
		<div class="section">
		<div class="parallax-window w-100 h-100 image-box" data-parallax="scroll" data-image-src="images/s3.jpg"></div>
		</div>
		<div class="section s2 text-white scale">
					...
					<div class="container my-5 py-5 z-depth-1">
						<section class="px-md-5 mx-md-5 dark-grey-text text-center text-lg-left">
							<div class="row d-flex align-items-center justify-content-center">
								<div class="col-lg-4 mb-4 mb-lg-0 scale">
									<img src="images/onsite3.png" class="w-75 h-100" alt="">
								</div>
								<div class="col-lg-8 mb-5 mt-5 mb-lg-0">
									<h3 class="display-3 font-weight-bold">Onsite Support</h3>
				...
				<div class="container my-5 py-5 z-depth-1">
					<section class="px-md-5 mx-md-5 dark-grey-text text-center text-lg-left">
						<div class="row">
							<div class="col-lg-4 mb-4 mb-lg-0 d-flex align-items-between justify-content-center scale">
								<img src="images/macor1.png" class="w-75 h-100 shadowed" alt="">
							</div>
							<div class="col-lg-8 mb-5 mt-5 mb-lg-0">
								<h2 class="display-3 font-weight-bold">Repair services</h2>
			...
			<div class="slide d-flex justify-content-center pt-3 mt-3">
				<div class="container my-5 py-5 z-depth-1">
					<section class="px-md-5 mx-md-5 dark-grey-text text-center text-lg-left">
						<div class="row">
							<div class="col-lg-4 mb-4 mb-lg-0 d-flex align-items-center justify-content-center scale">
								<img src="images/remote.png" class="w-75 h-100 shadowed top" alt="">
							</div>
							<div class="col-lg-8 mb-5 mt-5 mb-lg-0">
								<h3 class="display-3 font-weight-bold">Remote Support</h3>
				...
				<div class="container my-5 py-5 z-depth-1">
					<section class="px-md-5 mx-md-5 dark-grey-text text-center text-lg-left">
						<div class="row">
							...
							<div class="col-lg-8 mb-5 mt-5 mb-lg-0">
								<h3 class="display-3 font-weight-bold">IT Consulting</h3>
		...
		<div class="section position-relative parallax-window image-box" data-parallax="scroll" data-image-src="images/reviews.jpg"></div>
